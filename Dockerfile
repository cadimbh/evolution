...
ENV AUTHENTICATION_INSTANCE_WEBHOOK_URL=https://evolution-production-b71f.up.railway.app/chatwoot/webhook/iphone
ENV AUTHENTICATION_INSTANCE_CHATWOOT_ACCOUNT_ID=1
ENV AUTHENTICATION_INSTANCE_CHATWOOT_TOKEN=wBJDxYs3ekcxgiTfJHWsrtWB
ENV AUTHENTICATION_INSTANCE_CHATWOOT_URL=https://chatwoot.up.railway.app/
