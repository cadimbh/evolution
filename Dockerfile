...
ENV AUTHENTICATION_INSTANCE_NAME=EVO
ENV AUTHENTICATION_INSTANCE_WEBHOOK_URL=http://evolution-production-b71f.up.railway.app/chatwoot/webhook/evo
ENV AUTHENTICATION_INSTANCE_CHATWOOT_ACCOUNT_ID=2
ENV AUTHENTICATION_INSTANCE_CHATWOOT_TOKEN=FpVP5hCRAzXhSTGYeDqnFRn5
ENV AUTHENTICATION_INSTANCE_CHATWOOT_URL=https://chatwoot-production-68ad.up.railway.app/
WORKDIR /evolution
